...
const Navbar = () => {
    ...
    const navToggle = () => {
        ...
        if (window.scrollY > 10) {
            navbar.classList.replace("h-[15vh]", "h-[10vh]")
        } else if (window.scrollY < 10 && navbar.classList.contains("h-[10vh]")) {
            navbar.classList.replace("h-[10vh]", "h-[15vh]")
    ...
    return (
        <div className="fixed top-0 z-50">
            <nav id="navbar" className="h-[10vh] w-[100vw] text-white text-[1.3em] font-[baskerville] tracking-wide bg-[#8047BA] bg-opacity-50 flex flex-row justify-around ">
                <div className="my-auto dropdownMenu w-[25%] flex flex-row justify-around ">
                    <a href="/">Home</a> &nbsp;
                    <a href="#about">About Us</a> &nbsp;
                    <a href="#services">Services</a>
                </div>
                <a href="/" className=" my-auto w-[50%] md:w-[25%] lg:w-[15%]"><img id='navLogo' src={lovegrityLogo} alt="Lovegrity" /></a>
